...
public class Practicum {
    ...
    static final String MAP_LINK = "https://recyclemap.ru/";
    ...
    public static void main(String[] args) {
        ...
        switch(command){
            ...
            case ChatCommand.RECYCLABILITY:
                ...
                int codeRecyclability = scanCode.nextInt();
                isRecycled(codeRecyclability);
                break;

            case ChatCommand.BONUS:
                System.out.println("Введите количество вторсырья, кг:");
                Scanner scanWeight = new Scanner(System.in);
                int weightMaterial = scanWeight.nextInt();
                if (weightMaterial < 10){
                    int bonus = weightMaterial * 10;
                    System.out.println("Количество бонусных баллов: " + bonus);
                }
                else {
                    int bonus = weightMaterial * 15;
                    System.out.println("Количество бонусных баллов: " + bonus);
                }
                break;
    ...
    private static void isRecycled(int code) {
